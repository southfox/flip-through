...
{
    FTAlert* alert = [[FTAlert alloc] initWithFrame:frame textBlock:nil leftTitle:leftTitle leftBlock:leftBlock rightTitle:rightTitle rightBlock:rightBlock];
...
{
    FTAlert* alert = [[FTAlert alloc] initWithFrame:frame textBlock:textBlock leftTitle:leftTitle leftBlock:leftBlock rightTitle:rightTitle rightBlock:rightBlock];
